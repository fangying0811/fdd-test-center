		...
		<table border="0" style="width: 100%">
			...
			<tr>
				...
				<td><input id="projectId" name="project.projectId"
					class="mini-combobox" valueField="projectId"
					dataField="data" textField="projectName" allowInput="true" valueFromSelect="true"
			...
			<tr>
				...
				<td><input id="resource" name="resource"
					...
					errorMode="none" emptyText="请选择责任人" requiredErrorText="责任人不能为空"
					style="width: 300px;" /></td>
			...
			<tr>
				...
				<td>
					...
					name="versionTestTime" class="mini-datepicker"
			...
			<tr>
				...
				<td>
					...
					class="mini-datepicker" emptyText="请选择测试完成时间" showOkButton="true"
					readOnly="true" required="false" onvalidation="onValidation"
					errorMode="none" requiredErrorText="测试完成时间不能为空"
					style="width: 300px;" />
				</td>
				<td>
