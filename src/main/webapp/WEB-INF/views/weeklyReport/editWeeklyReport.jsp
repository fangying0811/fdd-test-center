...
<body>
	...
	<div id="editForm" style="padding:15px">
		<table border="0" style="width: 100%">
			...
			<tr>
				<td style="text-align: right;"><label for="bugNumber">版本bug总数<span
						style="color:red">(*)</span>：
				</label></td>
			...
			<tr>
				<td style="text-align: right;"><label for="versionReleaseRime">版本发布时间<span
						style="color:red">(*)</span>：
				</label></td>
				<td>
					<div id="versionReleaseTimeStatus" name="versionReleaseTimeStatus"
						...
						onvalidation="onValidation" errorMode="none"
						requiredErrorText="请选择版本发布时间"></div> <input
					id="versionReleaseTime" name="versionReleaseTime"
					class="mini-datepicker" allowInput="false" emptyText="请选择版本发布时间"
					showOkButton="true" readOnly="true" required="false"
					onvalidation="onValidation" errorMode="none"
					requiredErrorText="版本发布时间不能为空" style="width:300px;" />
				</td>
				<td>
	...
	<script type="text/javascript">
		...
		function onEdit(e) {
			...
			$
					.ajax({
						url : '<%=basePath%>weeklyReport/editWeeklyReport.json',
						type : 'post',
