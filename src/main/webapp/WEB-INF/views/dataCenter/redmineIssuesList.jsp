...
<body>
	<div id="searchForm">
	<form id="exportForm" action="<%=basePath%>redmine/exportIssueInfoList.json"
			method="get">
		<table>
			<tr>
	...
	<div class="mini-fit">
		<div id="redmineProject" class="mini-datagrid"
			url="<%=basePath%>redmine/issueInfo.json"
		   ...
		   <!-- <div field="redmineProjectId" align="center" headerAlign="center">redmine项目ID</div> -->
				...
				<div field="dimensions" align="center" headerAlign="center">严重性</div>
