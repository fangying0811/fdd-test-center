...
<body>
	<div id="searchForm">
	<form id="exportForm" action="<%=basePath%>/workStatistic/exportDepartmentWorkStatistic.action" method="post">
	<table>
			<tr>
	...
	<div class="mini-fit">
		<div id="workStatisticDg" class="mini-datagrid"
			url="<%=basePath%>workStatistic/departmentWorkStatisticList.json"
