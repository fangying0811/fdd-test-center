...
<body>
	<div id="searchForm">
	<form id="exportForm" action="<%=basePath%>redmine/issueStatus.json"
			method="get">
		<table>
			<tr>
	...
	<div class="mini-fit">
		<div id="redmineProject" class="mini-datagrid"
			url="<%=basePath%>redmine/issueStatus.json"
			...
			<div property="columns">
				...
				<div field="unresolved" align="center" headerAlign="center">新建</div>
				<div field="resolved" align="center" headerAlign="center">已解决</div>
				<div field="futuresolution" align="center" headerAlign="center">以后解决</div>
				<div field="reject" align="center" headerAlign="center">拒绝</div>
