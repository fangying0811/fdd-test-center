...
<body>
	<div id="searchForm">
	<form id="exportForm" action="<%=basePath%>redmine/countByVersion.json"
			method="get">
		<table>
			<tr>
	...
	<div class="mini-fit">
		<div id="redmineProject" class="mini-datagrid"
			url="<%=basePath%>redmine/countByVersion.json"
			...
			<div property="columns">
				...
				<div field="deadly" align="center" headerAlign="center">致命</div>
				<div field="critical" align="center" headerAlign="center">严重</div>
				<div field="commonly" align="center" headerAlign="center">一般</div>
				<div field="light" align="center" headerAlign="center">轻微</div>
