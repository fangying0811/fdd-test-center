...
<body>
		...
		<table>
			<tr>
				...
				<td style="text-align: left;"><label for="statisticType">统计类型：</label>
					...
					valueField="statisticType" textField="statisticTypeText"
	...
	<script type="text/javascript">
		...
		function showChart(e) {
			setDefaultValue();
			if(statisticType.getValue()==null || statisticType.getValue()<1){
			...
			$
					.ajax({
						url : '<%=basePath%>sonarStatistic/teamSonarStatisticLineChart.json',
						type : 'post',
