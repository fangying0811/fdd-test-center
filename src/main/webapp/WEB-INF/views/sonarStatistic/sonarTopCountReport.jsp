...
<body>
	<div id="searchForm">
		<form id="exportForm"
			action="<%=basePath%>sonarStatistic/exportSonarTopCountReport.json"
			method="post">
			<table>
				<tr>
	...
	<div class="mini-fit">
		<div id="sonarStatisticDg" class="mini-datagrid"
			url="<%=basePath%>sonarStatistic/sonarTopCountReport.json"
			...
			<div property="columns">
				...
				<div field="blockerNowWeek" align="center" headerAlign="center">Blocker</div>
				<div field="criticalNowWeek" align="center" headerAlign="center">Critical</div>
	...
	<script type="text/javascript">
		...
		sonarStatisticDg.sortBy("count","desc");
