...
<body>
	<div id="editForm" style="padding:15px">
		<table border="0" style="width: 100%">
			<tr>
				<td style="text-align: right;"><input id="requirementId"
					name="requirementId" class="mini-hidden" /></td>
			</tr>
			<tr>
	...
	<script type="text/javascript">
		...
		function onEdit(e) {
			...
			$
					.ajax({
						url : '<%=basePath%>requirementInfo/editRequirementInfo.json',
						type : 'post',
