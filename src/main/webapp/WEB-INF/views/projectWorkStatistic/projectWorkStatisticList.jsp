...
<body>
	<div id="searchForm">
	<form id="exportForm" action="<%=basePath%>/projectWorkStatistic/exportProjectWorkStatistic.json" method="post">
	<table>
			<tr>
	...
	<div class="mini-fit">
		<div id="workStatisticDg" class="mini-datagrid"
			url="<%=basePath%>projectWorkStatistic/projectWorkStatisticList.json"
			multiSelect="false" showEmptyText="true" emptyText="暂无数据！"
			totalField="data.totalElements" dataField="data.pageList" pageSize=50 sizeList="[50,100]"
			showPager="false">
			<div property="columns">
				...
				<div field="outstandingIssueCount" align="center" headerAlign="center">遗留问题数</div>
