...
<body>
		...
		<table>
			<tr>
				...
				<td style="text-align: left;"><label for="versionType">版本类型：</label>
					...
					class="mini-combobox"
					url="<%=basePath%>projectWorkStatistic/typeList.json"
				...
				<td style="text-align: left;"><label for="statisticType">统计类型：</label>
					...
					class="mini-combobox"
					url="<%=basePath%>projectWorkStatistic/statisticTypeList.json"
	...
	function showChart(e) {
		...
		$
				.ajax({
					url : '<%=basePath%>projectWorkStatistic/projectWorkStatisticEChartLine.json',
					type : 'post',
